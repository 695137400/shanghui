...
import com.mynote.jilu.KCalendar.OnCalendarClickListener;
import com.mynote.jilu.KCalendar.OnCalendarDateChangedListener;
...
public class DateActivity
{
	...
	public class PopupWindows extends PopupWindow
	{
		...
		public PopupWindows(Context mContext, View parent, View r)
		{
			ri = (EditText)parent;
            xingqi = (EditText)r;
			...
			final Button popupwindow_calendar_bt_enter = (Button) view.findViewById(R.id.popupwindow_calendar_bt_enter);
            popupwindow_calendar_bt_enter.setEnabled(false);
			...
			calendar.setOnCalendarClickListener(new OnCalendarClickListener() {
					...
					public void onCalendarClick(int row, int col, String dateFormat)
					{
						...
						else
						{
                            ...
                            popupwindow_calendar_bt_enter.setEnabled(true);
			...
			popupwindow_calendar_bt_enter.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v)
					{
                        ...
                        int n=Integer.parseInt(date.split("-")[0].toString());
                        int y=  Integer.parseInt(date.split("-")[1]);
                        int r=Integer.parseInt(date.split("-")[2]);
                        Date dt=new Date(n - 1900, y-1, r);
                        SimpleDateFormat sf=new SimpleDateFormat("EEE");
                        String xq= sf.format(dt);
                        xingqi.setText(xq);
                        //System.out.println(sd.format(dat));   
                        dismiss();
					}
				});
